  ...
  return (
    ...
    <div className="  w-full  p-0 ">
      ...
      <div className="h-full w-full mt-10">
        ...
        <div className="absolute top-[70%] left-[42%] w-[25%] bg-white border-[1px] border-[#E7581A] rounded-2xl py-2 px-4 z-20">
        ...
        <div className="w-[80%] absolute bottom-20 left-[15%] flex justify-center">
